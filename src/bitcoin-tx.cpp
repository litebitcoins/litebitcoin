...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s litebitcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  litebitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litebitcoin transaction") + "\n" +
              "  litebitcoin-tx [options] -create [commands]   " + _("Create hex-encoded litebitcoin transaction") + "\n" +
              "\n";
