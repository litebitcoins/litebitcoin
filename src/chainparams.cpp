...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.litebitcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.litebitcointools.com", true);
        vSeeds.emplace_back("dnsseed.litebitcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.litebitcointools.com", true);
        vSeeds.emplace_back("seed-b.litebitcoin.loshan.co.uk", true);
