...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 500; // 75% of 8064
        consensus.nMinerConfirmationWindow = 375; // nPowTargetTimespan / nPowTargetSpacing * 4
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("c3a67cf4b8f9782ac27e82610b4131fe0fe4ddfef07c7f7532643e841ef17f28");
