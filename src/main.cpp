...
uint256 hashGenesisBlock("0x46f1eae198eddd22156b5cebf7023e3998981f518d558e42830edd2795b89b9f");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // LiteBitcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "LiteBitcoin Signed Message:\n";
...
{
    // LiteBitcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // LiteBitcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1498204210, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c6387a96bae5d94ad0c153f65967784240da6bd437f336ff5a7a6660941b3275df218db45c755b7297fd3f20c70e58d919aec798e9c10493463abd7fa6557786") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1498204210;
        ...
        assert(block.hashMerkleRoot == uint256("0x47312f978ba691bfe0dc40e553b0ede5bf58f4e78c8319d755aa5d2672c0da3e"));
...
unsigned char pchMessageStart[4] = { 0x5b, 0x6d, 0x2f, 0x54 }; // LiteBitcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LiteBitcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LiteBitcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static LiteBitcoinMiner(CWallet *pwallet)
{
    printf("LiteBitcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("litebitcoin-miner");
    ...
    try { loop {
        ...
        printf("Running LiteBitcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LiteBitcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&LiteBitcoinMiner, pwallet));
}
