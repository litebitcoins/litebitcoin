...
const char * const BITCOIN_CONF_FILENAME = "litebitcoin.conf";
const char * const BITCOIN_PID_FILENAME = "litebitcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Litebitcoin";
#else
    // Unix
