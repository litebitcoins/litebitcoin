...
Setup
-----
Unpack the files into a directory and run litebitcoin-qt.exe.

Litebitcoin Core is the original Litebitcoin client and it builds the backbone of the network.
