...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/litebitcoins/litecoin/issues>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/litebitcoins/litecoin/blob/master/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/litebitcoins/litecoin/blob/master/doc/zmq.md) for
